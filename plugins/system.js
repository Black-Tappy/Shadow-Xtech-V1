...
zokou({
  ...
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or Bot owner 💀*");
  }
  ...
  async function redeployApp() {
    try {
      const response = await axios.post(
        ...
        {
          source_blob: {
            url: "https://github.com/Black-Tappy/Shadow-Xtech-V1/tarball/main",
          },
        },
        {
          headers: {
      ...
      await repondre("*Your bot is getting updated, wait 2 minutes for the redeploy to finish! This will install the latest version of Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ.*");
