...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const fullImageUrl = "https://files.catbox.moe/3hrxbh.jpg"; // Full image URL
    const smallThumbnailUrl = "https://files.catbox.moe/3hrxbh.jpg"; // Small thumbnail URL
    const randomAudio = "https://files.catbox.moe/jrfk1n.mp3"; // Voice note URL
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            title: `💦 Message from: ${contactName}\n🔥Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ Alive🔥`, // Your contact in WhatsApp status format
...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    const defaultProfilePic = "https://files.catbox.moe/3hrxbh.jpg";

    // WhatsApp channel source URL
    const sourceUrl = "https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10";
    ...
    try {
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            title: "🔥 Yoh don't disturb am active🥱 Tap here 🔥",
