...
zokou({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on whatsApp and download movies there : https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10\n";
    imdbInfo += " ``` SHADOW-XTECH FILMS```\n";
    imdbInfo += "*Made by Black Tappy*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
